...
int is_keyword (char *temp_var_name, int *type)
{
    *type = NUM;
    ...
    if (strcmp(temp_var_name, "null") == 0)
        return 0;

    *type = BRACKET;

    if (strcmp(temp_var_name, "_ОТКРЫТЬ ХОЛОДИЛЬНИК_") == 0)
        return OPEN;

    if (strcmp(temp_var_name, "_ЗАКРЫТЬ ХОЛОДИЛЬНИК_") == 0)
        return CLOSE;

    *type = FIG_BRACKET;

    if (strcmp(temp_var_name, "ВКЛ") == 0)
        return OPEN;

    if (strcmp(temp_var_name, "ВЫКЛ") == 0)
        return CLOSE;

    *type = FUNC;

    if (strcmp(temp_var_name, "синь") == 0)
        return SIN;
    if (strcmp(temp_var_name, "кось") == 0)
        return COS;
    else if (strcmp(temp_var_name, "тг") == 0)
        return TG;
    else if (strcmp(temp_var_name, "ктг") == 0)
        return CTG;
    else if (strcmp(temp_var_name, "арксинь") == 0)
        return ARCSIN;
    else if (strcmp(temp_var_name, "арккось") == 0)
        return ARCCOS;
    else if (strcmp(temp_var_name, "арктг") == 0)
        return ARCTG;
    else if (strcmp(temp_var_name, "аркктг") == 0)
        return ARCCTG;
    else if (strcmp(temp_var_name, "ши нус") == 0)
        return SH;
    else if (strcmp(temp_var_name, "чиназес") == 0)
        return CH;
    else if (strcmp(temp_var_name, "тах") == 0)
        return TH;
    else if (strcmp(temp_var_name, "котах") == 0)
        return CTH;
    else if (strcmp(temp_var_name, "ну лан") == 0)
        return LN;
    else if (strcmp(temp_var_name, "разделяй и властвуй") == 0)
        return DERIV;
    else if (strcmp(temp_var_name, "megapenf") == 0)
        return SCAN;
    else if (strcmp(temp_var_name, "priprint") == 0)
        return PRINT;
    ...
    *type = COMMAND;
    ...
    if (strcmp(temp_var_name, "nif-nif") == 0)
        return IF;

    if (strcmp(temp_var_name, "zewhile") == 0)
        return WHILE;

    if (strcmp(temp_var_name, "punish") == 0)
        return ASSIGN;
...
int isletter (int character)
{
    ...
    /* UTF-8 Cyrillic (and other non-ASCII letters): 2-byte seq. D0/D1 + 80..BF */
    if (c == 0xD0 || c == 0xD1)
        return 1;
    if (c >= 0x80 && c <= 0xBF)
        return 1;
...
{
    if (element->type == RETURN && element->left)
    {
